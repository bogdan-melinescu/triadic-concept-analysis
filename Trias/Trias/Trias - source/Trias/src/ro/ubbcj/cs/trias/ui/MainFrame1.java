...
public class MainFrame1 extends JFrame{
	...
	public void SelectTricontextRelations()
	{
		...
		elbaCSXImporter = new ElbaCSXImporter(filePath,this);
		
		conditionSelectionFrame = new ConditionSelectionFrame(elbaCSXImporter);
		
		conditionSelectionFrame.setVisible(true);
	}
...
//			saveToOutput();
	...
	public MainTriasController getController() {
		return controller;
	}

	public void setController(MainTriasController controller) {
		this.controller = controller;
	}
